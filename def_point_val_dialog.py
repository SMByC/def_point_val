...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'def_point_val_dialog_base.ui'))


class DefPointValidatorDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(DefPointValidatorDialog, self).__init__(parent)
